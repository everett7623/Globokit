...
const pinyinMap: { [key: string]: string } = {
  ...
  '船': 'chuan', '火': 'huo', '桌': 'zhuo', '椅': 'yi', '床': 'chuang', 
  '灯': 'deng', '窗': 'chuang', '衣': 'yi', '服': 'fu', '鞋': 'xie', 
  '帽': 'mao', '裤': 'ku',
  
  // 自然
  '山': 'shan', '水': 'shui', '河': 'he', '湖': 'hu', '江': 'jiang',
  '云': 'yun', '雨': 'yu', '雪': 'xue', '风': 'feng',
  '花': 'hua', '草': 'cao', '树': 'shu', '林': 'lin', '森': 'sen',
  '阳': 'yang', '亮': 'liang',
  
  // 食物
  '饭': 'fan', '菜': 'cai', '汤': 'tang', '面': 'mian',
  '茶': 'cha', '酒': 'jiu', '咖': 'ka', '啡': 'fei', '果': 'guo', 
  '肉': 'rou', '鱼': 'yu', '鸡': 'ji', '蛋': 'dan', '米': 'mi', 
  '油': 'you', '盐': 'yan', '糖': 'tang',
  
  // 颜色
  '红': 'hong', '黄': 'huang', '蓝': 'lan', '绿': 'lv', '白': 'bai',
  '黑': 'hei', '灰': 'hui', '紫': 'zi', '橙': 'cheng', '粉': 'fen',
  '棕': 'zong', '色': 'se', '彩': 'cai', '光': 'guang', '暗': 'an', 
  '淡': 'dan',
  
  // 其他常用字
  '请': 'qing', '谢': 'xie', '对': 'dui', '起': 'qi', '再': 'zai',
  '您': 'nin', '先': 'xian', '士': 'shi', '什': 'shen',
  ...
  '丑': 'chou', '善': 'shan', '恶': 'e', '爱': 'ai',
  '恨': 'hen', '喜': 'xi', '欢': 'huan', '怒': 'nu', '哀': 'ai',
  '乐': 'le', '惊': 'jing', '恐': 'kong', '怕': 'pa', '担': 'dan',
  '心': 'xin', '信': 'xin', '任': 'ren',
  '务': 'wu', '帮': 'bang', '助': 'zhu', '救': 'jiu',
  '治': 'zhi', '医': 'yi', '药': 'yao', '商': 'shang',
  '场': 'chang', '超': 'chao', '银': 'yin', '钱': 'qian', 
  '币': 'bi', '元': 'yuan', '角': 'jiao', '价': 'jia', 
  '格': 'ge', '费': 'fei', '贵': 'gui', '便': 'bian',
  '宜': 'yi', '折': 'zhe', '扣': 'kou', '赚': 'zhuan', '赔': 'pei',
  '输': 'shu', '赢': 'ying', '胜': 'sheng', '败': 'bai',
  '局': 'ju', '棋': 'qi', '牌': 'pai', '球': 'qiu', '赛': 'sai',
  '运': 'yun', '体': 'ti', '育': 'yu', '音': 'yin',
  '乐': 'yue', '歌': 'ge', '舞': 'wu', '蹈': 'dao', '画': 'hua',
  '图': 'tu', '片': 'pian', '照': 'zhao', '相': 'xiang', '影': 'ying',
  '视': 'shi', '频': 'pin', '网': 'wang', '络': 'luo', '站': 'zhan',
  '址': 'zhi', '邮': 'you', '箱': 'xiang', '密': 'mi',
  '账': 'zhang', '户': 'hu', '注': 'zhu', '册': 'ce', '登': 'deng',
  '录': 'lu', '退': 'tui', '保': 'bao', '存': 'cun',
  '删': 'shan', '除': 'chu', '修': 'xiu', '改': 'gai', '查': 'cha',
  '找': 'zhao', '搜': 'sou', '索': 'suo', '载': 'zai',
  '传': 'chuan', '发': 'fa', '收': 'shou',
  '取': 'qu', '打': 'da', '印': 'yin', '制': 'zhi',
  '粘': 'zhan', '贴': 'tie', '剪': 'jian', '切': 'qie', '移': 'yi',
  '拖': 'tuo', '拉': 'la', '推': 'tui',
  '按': 'an', '钮': 'niu', '键': 'jian', '盘': 'pan', '鼠': 'shu',
  '标': 'biao', '屏': 'ping', '幕': 'mu', '显': 'xian',
  '器': 'qi', '板': 'ban', '硬': 'ying',
  '软': 'ruan', '系': 'xi',
  '统': 'tong', '程': 'cheng', '序': 'xu', '代': 'dai',
  '误': 'wu', '警': 'jing', '告': 'gao', '提': 'ti',
  '确': 'que', '认': 'ren', '消': 'xiao',
  '完': 'wan', '功': 'gong', '失': 'shi',
  '刷': 'shua', '更': 'geng',
  '升': 'sheng', '级': 'ji', '版': 'ban',
  '管': 'guan', '员': 'yuan',
  '权': 'quan', '限': 'xian', '设': 'she', '配': 'pei',
  '选': 'xuan', '项': 'xiang',
  '具': 'ju', '栏': 'lan', '状': 'zhuang', '态': 'tai',
  '壁': 'bi', 
  '皮': 'pi', '肤': 'fu',
  '粗': 'cu', '细': 'xi',
  '划': 'hua', '颜': 'yan',
