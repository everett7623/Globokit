...
export const PARTNER_RESOURCES: PartnerResource[] = [
  ...
  },
  {
    ...
    name: 'Modeloc',
    type: 'AI 工具',
    href: 'https://go.uukk.de/modeloc',
    description: 'AI API 中转服务，提供稳定的 Claude、GPT 等模型访问接口，适合开发者集成和批量调用。',
    bestFor: ['API 中转', '开发集成', '批量调用'],
  },
  {
    id: 'aiinput',
    name: 'AI INPUT',
    type: 'AI 工具',
    href: 'https://go.uukk.de/aiinput',
    description: 'AI 模型接口服务平台，支持多种主流 AI 模型，适合企业和个人开发者使用。',
    bestFor: ['模型接口', '企业应用', '开发调试'],
  },
  {
    id: 'laodi',
    name: 'Laodi',
    type: 'AI 工具',
    href: 'https://go.uukk.de/laodi',
    description: 'AI API 接口中转站，提供稳定的模型访问服务，适合需要可靠 AI 能力的业务场景。',
    bestFor: ['API 服务', '稳定访问', '业务集成'],
  },
  {
    id: '0u0o',
    name: '0u0o',
    type: 'AI 工具',
    href: 'https://go.uukk.de/0u0o',
    description: 'AI 模型 API 中转平台，支持主流 AI 模型接口，适合开发者和技术团队使用。',
    bestFor: ['开发者工具', 'API 接入', '技术团队'],
  },
  {
    id: 'twinkle',
    name: 'Twinkle',
    type: 'AI 工具',
    href: 'https://go.uukk.de/twinkle',
    description: '大模型 API 服务平台，提供稳定的 AI 接口中转，适合智能办公和业务自动化场景。',
    bestFor: ['智能办公', '自动化', 'API 中转'],
  },
  {
    id: 'nexsms',
    name: 'NexSMS',
