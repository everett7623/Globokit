...
export const TOOL_REGISTRY: ToolMeta[] = [
  {
    ...
    relatedTools: ['number-to-english', 'currency-symbols'],
  },
  {
  ...
  },
  {
    ...
    seoDescription: '查看和复制全球各国货币符号，涵盖主要贸易国家货币，便于外贸报价和合同编写',
    useCases: ['外贸报价单', '合同编写', '邮件中引用货币'],
    relatedTools: ['rmb-converter', 'number-to-english', 'global-country-info'],
  },
  {
    id: 'text-case',
    slug: 'text-case',
  ...
  },
  {
    ...
    seoDescription: '免费在线世界时间工具，查看全球主要贸易城市实时时间，便于安排国际业务沟通',
  ...
  },
  {
    ...
    seoDescription: '免费在线国际节假日查询工具，查询全球主要贸易国家的节假日安排，便于外贸业务规划',
  ...
  },
  {
    ...
    relatedTools: ['holiday-query', 'world-time', 'currency-symbols'],
  },
  {
    id: 'json-formatter',
    slug: 'json-formatter',
